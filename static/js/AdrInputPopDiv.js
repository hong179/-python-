function AdrInputPopDiv(){
  this.init=function(inpuId, isAbsolute) {
    ...
    dizhiDiv.on('click', '.dizhi_t_1 p', function(e){
      ...
      dizhiDiv.find(".pname").css("display", "none");
      ...
      if (idx == 1){
        ...
        $(this).addClass("hover");
        dizhiDiv.find(".pname").css("display", "block");
      }else if(idx == 3){
        $(this).addClass("hover");
    ...
    dizhiDiv.on('click', '.province .dizhi_t_2_2 p', function(e){
      ...
      $.each(provinceObject[pro], function(v){
        pname += "<p style='width:auto;padding-right: 6px;'>" + v + "</p>";
      });
      var cityDiv = dizhiDiv.find(".pname .dizhi_t_2 .dizhi_t_2_2");
      cityDiv.html("");
      $(pname).appendTo(cityDiv);
    ...
    dizhiDiv.on('click', '.pname .dizhi_t_2_2 p', function(e){
      var pname = $(this).text();
      selCity = pname;
      var area = "";
      $.each(provinceObject[selPro][pname], function(idx, v){
